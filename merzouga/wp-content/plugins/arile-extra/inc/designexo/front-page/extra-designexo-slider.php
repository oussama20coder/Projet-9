		...
		<?php 
			...
			<?php if($title != '' || $img_description!= '' || $readmore_button!=''){ ?>
				<div class="container theme-slider-content">
					<div class="theme-text-<?php if('Designexo' == $activate_theme || 'Designexo Child Theme' == $activate_theme){ echo 'left'; } ?><?php if('Empresa' == $activate_theme || 'InteriorWP' == $activate_theme){ echo 'center'; } ?> theme-caption-bg<?php if('Empresa' == $activate_theme){ echo '2'; } ?> <?php if('InteriorWP' == $activate_theme){ echo 'align-center';} ?>">
					<?php if($subtitle != ''){ ?>
			...
			<div class="item" style="background-image:url(<?php echo arile_extra_plugin_url; ?>/inc/designexo/images/theme-slide1.jpg);">
				<div class="container theme-slider-content">
					<div class="theme-text-<?php if('Designexo' == $activate_theme || 'Designexo Child Theme' == $activate_theme){ echo 'left';}else{ echo 'center'; }?> theme-caption-bg <?php if('InteriorWP' == $activate_theme){ echo 'align-center';} ?>">
